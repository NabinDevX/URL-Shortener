...
import { ShowQR, useAuth, requestOnce, Skeleton, SkeletonCard } from "@repo/ui";
...
const Dashboard = () => {
  ...
  if (loading) {
    return (
      <div className="w-full h-full bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 p-4 overflow-y-auto">
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="flex-shrink-0">
                      {url.qrCode && <ShowQR shortUrl={url.qrCode} size={80} />}
                    </div>
