...
describe("List and Find URLs", () => {
  ...
  const exampleRedirectUrl = "https://example.com";
  ...
  describe("Find URLs", () => {
    ...
    it("should return all URLs for a user", async () => {
      await URL.create({
        userId: mockUserId,
        shortId: "url1",
        redirectUrl: `${exampleRedirectUrl}/1`,
      });
      await URL.create({
        userId: mockUserId,
        shortId: "url2",
        redirectUrl: `${exampleRedirectUrl}/2`,
      });
      await URL.create({
        userId: mockUserId,
        shortId: "url3",
        redirectUrl: `${exampleRedirectUrl}/3`,
      });
    ...
    it("should filter URLs by userId", async () => {
      await URL.create({
        userId: mockUserId,
        shortId: "user1url",
        redirectUrl: `${exampleRedirectUrl}/user1`,
      });
      await URL.create({
        userId: anotherUserId,
        shortId: "user2url",
        redirectUrl: `${exampleRedirectUrl}/user2`,
      });
    ...
    it("should find URL by shortId", async () => {
      await URL.create({
        userId: mockUserId,
        shortId: "findme123",
        redirectUrl: `${exampleRedirectUrl}/findme123`,
      });
      ...
      expect(url?.redirectUrl).toBe(`${exampleRedirectUrl}/findme123`);
    });
    ...
    it("should find URL by _id", async () => {
      const created = await URL.create({
        userId: mockUserId,
        shortId: "byid123",
        redirectUrl: `${exampleRedirectUrl}/byid123`,
      });
    ...
    it("should filter by isDeleted status", async () => {
      await URL.create({
        userId: mockUserId,
        shortId: "active1",
        redirectUrl: `${exampleRedirectUrl}/active1`,
        isDeleted: false,
      });
      await URL.create({
        userId: mockUserId,
        shortId: "deleted1",
        redirectUrl: `${exampleRedirectUrl}/deleted1`,
        isDeleted: true,
      });
      await URL.create({
        userId: mockUserId,
        shortId: "active2",
        redirectUrl: `${exampleRedirectUrl}/active2`,
        isDeleted: false,
      });
  ...
  describe("Sorting URLs", () => {
    it("should sort URLs by createdAt descending", async () => {
      await URL.create({
        userId: mockUserId,
        shortId: "first",
        redirectUrl: `${exampleRedirectUrl}/first`,
      });
      ...
      await URL.create({
        userId: mockUserId,
        shortId: "second",
        redirectUrl: `${exampleRedirectUrl}/second`,
      });
  ...
  describe("Counting URLs", () => {
    it("should count total URLs for a user", async () => {
      await URL.create({
        userId: mockUserId,
        shortId: "count1",
        redirectUrl: `${exampleRedirectUrl}/count1`,
      });
      await URL.create({
        userId: mockUserId,
        shortId: "count2",
        redirectUrl: `${exampleRedirectUrl}/count2`,
      });
    ...
    it("should count active URLs only", async () => {
      await URL.create({
        userId: mockUserId,
        shortId: "active",
        redirectUrl: `${exampleRedirectUrl}/active`,
        isDeleted: false,
      });
      await URL.create({
        userId: mockUserId,
        shortId: "deleted",
        redirectUrl: `${exampleRedirectUrl}/deleted`,
        isDeleted: true,
      });
    ...
    beforeEach(async () => {
      for (let i = 1; i <= 10; i++) {
        await URL.create({
          ...
          redirectUrl: `${exampleRedirectUrl}/page${i.toString().padStart(2, "0")}`,
        });
      }
    });
