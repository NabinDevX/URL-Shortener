    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-16">
          ...
          <p className="text-2xl md:text-3xl text-blue-100 font-light max-w-3xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto mb-16">
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8">
            ...
            >
              <div className="text-center mb-8">
                <div className="text-7xl mb-4">{useCases[currentStep].icon}</div>
                ...
                <div className="bg-red-50 border-2 border-red-200 rounded-xl p-6">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0">
                      <div className="bg-red-500 text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-xl">
                        ❌
                      </div>
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm text-red-600">Everyone can see this</span>
                      </div>
                      <div className="bg-white rounded-lg p-4 border border-red-300">
                        <p className="text-sm text-red-800 break-all font-mono leading-relaxed">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm text-green-600">Clean and secure</span>
                      </div>
                      <div className="bg-white rounded-lg p-4 border border-green-300">
                        <p className="text-2xl text-green-800 font-mono font-bold">
        ...
        <div className="max-w-4xl mx-auto mt-16">
          <div className="grid grid-cols-3 gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 text-center shadow-xl hover:shadow-2xl transition-shadow"
              >
