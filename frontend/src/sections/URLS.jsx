...
const URLS = () => {
  ...
  const handleCreateUrl = async (e) => {
    ...
    // Validate ID length if no custom ID
    ...
    try {
      ...
      // Add ID length only if no custom ID is provided
      if (!newUrl.customShortId && newUrl.idLength) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#667eea] to-[#764ba2] py-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Create URL Form - keeping your existing form */}
        {showCreateForm && (
              ...
              {urls.map((url) => {
                ...
                return (
                  <div key={url._id} className="bg-white rounded-2xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-300">
                      ...
                      <div className="flex items-start justify-between gap-6">
                          ...
                          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-3">
                            ...
                            <div className="flex items-center gap-3 flex-wrap">
                              ...
                              <button
                                ...
                                className="bg-white text-[#667eea] px-4 py-2 rounded-lg font-bold hover:shadow-lg transition-all duration-300 hover:scale-105 flex items-center gap-2 flex-shrink-0"
                              >
                        ...
                        <div className="flex flex-col items-center gap-3 bg-white/10 backdrop-blur-sm rounded-xl p-4 min-w-[200px]">
                          ...
                          {!hasQRCode ? (
                            ...
                            // Show QR Code and Download Button if QR code exists
                    ...
                    {/* Analytics Section - keeping your existing code */}
                    <div className="p-6">
