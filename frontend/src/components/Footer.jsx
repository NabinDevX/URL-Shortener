  ...
  return (
    <footer className="bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/profile" className="text-blue-100 hover:text-white transition-colors text-sm">
                  Profile
                </Link>
              </li>
              <li>
              ...
              <li>
                <a href="#pricing" className="text-blue-100 hover:text-white transition-colors text-sm">
                  Pricing
                </a>
              </li>
            </ul>
          ...
          <div className="text-center md:text-right">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#help" className="text-blue-100 hover:text-white transition-colors text-sm">
                  Help Center
                </a>
              </li>
              <li>
      ...
      <button
        ...
        className="fixed bottom-8 right-8 bg-white text-purple-600 hover:bg-white/90 p-3 rounded-full shadow-xl transition-all hover:scale-110 z-50"
